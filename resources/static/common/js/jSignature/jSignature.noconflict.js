...
methods = {
		...
		,getSettings
		,isModified
		,updateSetting  //更新设置项，eg：$Jsignature.jSignature('updateSetting', 'color', '#red');
		,clear
		,reset
		,addPlugin
		,listPlugins
...
*/
    (function() {
        ...
        function r(b, j, a) {
            ...
            //add by dym 2015-4-16
            this.$signatureTools = $(".jSignatureToolsBar");  
            ...
            this.events.subscribe("jSignature.attachingEventHandlers", function() {
                if (this.settings[q]) {
                    ...
                    "function" !== typeof m && (m = function() {
                    	//add by dym 2015-4-16
                        var e = $('<span class="baseBtn">上一步</span>').appendTo(this.$signatureTools),
                            k = e.width();
                    ...
                    t.events.subscribe("jSignature.change", function() {
                        t.dataEngine.data.length ? k.show(0,function(){$('.signatureNoSave, .signatureSave').removeClass("unvisible");}) : k.hide(0,function(){$('.signatureNoSave, .signatureSave').addClass("unvisible");});
                    });
                    var r = this,
    ...
    (function() {
        ...
        function y(a) {
            ...
            d = 0;
            for (c = p.length; d < c; d++) l = p[d], f.push('<path fill="none" stroke="#000000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" d="' + e(l, k, n) + '"/>');
            f.push("</svg>");
            return f.join("")
        }
        function v(a) {
